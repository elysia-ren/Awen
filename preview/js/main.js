...
(function init(){
  ...
  if(DOC_DATA&&DOC_DATA.source&&!auto)src=DOC_DATA.source;
  buildSyntaxPane();
  setSrc(src);
  ...
  // 单实例/命令行转发的打开请求(桌面版):先拉启动参数暂存,再监听后续转发
