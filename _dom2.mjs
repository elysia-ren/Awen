...
const expr = `(function(){
  return {
    scripts: [].map.call(document.querySelectorAll('script'), function(s){ return s.src ? s.src.split('/').slice(-2).join('/') : 'inline:' + s.textContent.slice(0,30) }),
    hasState: typeof window.S !== 'undefined',
    hasGsrc: typeof gSrc !== 'undefined',
    docname: document.getElementById('docname') ? document.getElementById('docname').value : 'NONE',
    tabDom: document.querySelectorAll('#filetabs .ftab').length
  };
})()`;
